...
import idle_frames from '../../res/character/idle/*.png';
import run_frames from '../../res/character/run/*.png';
import jump_frames from '../../res/character/jump/*.png';
import midair_frames from '../../res/character/mid-air/*.png';
import falling_frames from '../../res/character/falling/*.png';
